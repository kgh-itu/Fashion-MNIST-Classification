...
The constructor takes the following 4 parameters:\\
\begin{itemize}
...
This means, \code{max_depth=None}, \code{min_samples_split=2}.\\
...
Lastly a comparison of \textit{some} of the actual splits (best feature and cutoff) were done to assert correctness and as a sanity check, and
...
The values were selected due to their ability to effectively prevent overfitting, by achieving the highest validation accuracy score.
Due to the balanced dataset and the scope of this project it was decided not to prioritize increasing either precision or recall for the cost of accuracy score, as it would be for detecting i.e rare medical conditions.
